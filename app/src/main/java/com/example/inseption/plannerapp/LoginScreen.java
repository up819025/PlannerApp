...
public class LoginScreen extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            startActivity(new Intent(LoginScreen.this, Calendar.class));
    ...
    private boolean isEmailValid(String username) {
        ...
        return username.contentEquals("username");
    }
...
public class LoginScreen extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private boolean isEmailValid(String email) {
        //TODO: Replace this with your own logic
        return email.contentEquals("admin");
    }
...
>>>>>>> fc0eb4b80f718e7b4d5f1290dcdd50344d66cc2f
